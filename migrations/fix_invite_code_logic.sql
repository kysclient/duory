-- Function: Create new invite code
...
BEGIN
  ...
  -- If user has a couple, check if it's a valid couple (has partner)
  ...
  -- 2. If no couple exists or it's a zombie couple, create a new one
